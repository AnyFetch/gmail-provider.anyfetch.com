...
/**
 * var imap is the var for the connection to gmail
 * var totalNumberOfMail is for detect the end of the recursion
 */
var imap = null;
...
var retrieveGmail = function(refreshToken, googleAccount, fromUid, mailCb, finalCb, recursionCb) {
  ...
  // Keep the id of the current timer from the function setTimeout(..)
  var idTimer = null;
...
module.exports = function(refreshToken, googleAccount, fromUid, mailCb, finalCb){
  ...
  var mails = [];
  retrieveGmail(refreshToken, googleAccount, fromUid, onMailReceived, finalCb, function limiRecursionDepth() {
    retrieveGmail(refreshToken, googleAccount, fromUid, onMailReceived, finalCb, limiRecursionDepth);
  });
};
