...
var retrieveGmail = function(refreshToken, googleAccount, fromUid, mailCb, finalCb, recursionCb) {
  ...
  var recurseRecursionCb = function(uid) {
    retrieveGmail(refreshToken, googleAccount, uid, mailCb, finalCb, recurseRecursionCb);
  }
              ...
              function(err){
                ...
                //Set the timeout
                  ...
                  if(recursionCb == false) {
                    ...
                    retrieveGmail(refreshToken, googleAccount, lastUid, mailCb, finalCb, recurseRecursionCb);
                  }
                  else {
                    console.log("recursionCb");
                    recursionCb(lastUid);
                  }
                }, process.env.imapTimeout);
              });
            });
