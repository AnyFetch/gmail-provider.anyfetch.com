...
module.exports = function(refreshToken, googleAccount, from, mailCb, finalCb) {
  ...
  console.log("uh", googleAccount, refreshToken);
    ...
    function(cb) {
      ...
      imap.once('ready', function() {
        imap.openBox('[Gmail]/All Mail', true, function(err, box) {
          ...
          var f = imap.seq.fetch(from + ':' + config.number_of_mails_to_retrieve, { bodies: ['HEADER.FIELDS (FROM TO CC SUBJECT DATE)', 'TEXT'] });
